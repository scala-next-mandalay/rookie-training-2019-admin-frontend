...
import { Box, AppBar, IconButton, Toolbar,Menu,MenuItem,Divider,ListItemIcon, ListItemText,Grid } from '@material-ui/core';
import { 
  Menu as MenuIcon,
  ...
  return (
    <AppBar position="fixed" className={classes.appBar}>
      <Toolbar>
        ...
        <Box fontSize="h6.fontSize" flex={1}>
            <FormattedMessage id="Top.Title" defualtMessage="Change Title" />
        </Box>
